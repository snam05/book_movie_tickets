...
INSERT INTO theaters (name, total_seats, theater_type, status) VALUES
('Phòng 1 - Standard', 120, 'standard', 'active'),
('Phòng 2 - Standard', 120, 'standard', 'active'),
('Phòng 3 - VIP', 80, 'vip', 'active'),
('Phòng 4 - IMAX', 200, 'imax', 'active'),
('Phòng 5 - 3D', 150, '3d', 'active'),
('Phòng 6 - Standard', 100, 'standard', 'active');
...
-- Avengers: Endgame - Hôm nay & ngày mai
(1, 1, '2025-12-24', '10:00:00', 80000, 120, 'scheduled'),
(1, 2, '2025-12-24', '14:00:00', 80000, 120, 'scheduled'),
(1, 4, '2025-12-24', '20:00:00', 150000, 200, 'scheduled'),
(1, 1, '2025-12-25', '10:00:00', 80000, 120, 'scheduled'),
(1, 4, '2025-12-25', '20:00:00', 150000, 200, 'scheduled'),

-- Spider-Man: No Way Home
(2, 2, '2025-12-24', '10:30:00', 85000, 120, 'scheduled'),
(2, 5, '2025-12-24', '15:00:00', 120000, 150, 'scheduled'),
(2, 3, '2025-12-24', '21:00:00', 130000, 80, 'scheduled'),
(2, 2, '2025-12-25', '10:30:00', 85000, 120, 'scheduled'),

-- The Conjuring 3
(3, 1, '2025-12-24', '22:00:00', 90000, 120, 'scheduled'),
(3, 2, '2025-12-25', '22:00:00', 90000, 120, 'scheduled'),

-- Doraemon
(4, 6, '2025-12-24', '09:00:00', 70000, 100, 'scheduled'),
(4, 6, '2025-12-24', '11:00:00', 70000, 100, 'scheduled'),
(4, 6, '2025-12-24', '14:00:00', 70000, 100, 'scheduled'),
(4, 6, '2025-12-25', '09:00:00', 70000, 100, 'scheduled'),

-- Mai
(5, 3, '2025-12-24', '18:00:00', 120000, 80, 'scheduled'),
(5, 3, '2025-12-25', '18:00:00', 120000, 80, 'scheduled'),

-- Inception
(6, 4, '2025-12-24', '16:00:00', 150000, 200, 'scheduled'),
(6, 5, '2025-12-25', '16:00:00', 120000, 150, 'scheduled'),

-- Parasite
(7, 1, '2025-12-24', '18:30:00', 75000, 120, 'scheduled');
