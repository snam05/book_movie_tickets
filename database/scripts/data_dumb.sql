...
-- Theater 1: Standard (4 rows x 10 standard + 2 rows x 10 vip + 2 rows x 5 couple = 60 seats)
INSERT INTO theaters (name, total_seats, theater_type, status, seat_map) VALUES
('Phòng 1 - Standard', 60, 'standard', 'active', JSON_OBJECT(
  'rows', JSON_ARRAY('A','B','C','D','E','F','G','H'),
  'seatsPerRow', 10,
  'layout', JSON_ARRAY(
    JSON_ARRAY(JSON_OBJECT('id','A1','row','A','number',1,'type','standard'),JSON_OBJECT('id','A2','row','A','number',2,'type','standard'),JSON_OBJECT('id','A3','row','A','number',3,'type','standard'),JSON_OBJECT('id','A4','row','A','number',4,'type','standard'),JSON_OBJECT('id','A5','row','A','number',5,'type','standard'),JSON_OBJECT('id','A6','row','A','number',6,'type','standard'),JSON_OBJECT('id','A7','row','A','number',7,'type','standard'),JSON_OBJECT('id','A8','row','A','number',8,'type','standard'),JSON_OBJECT('id','A9','row','A','number',9,'type','standard'),JSON_OBJECT('id','A10','row','A','number',10,'type','standard')),
    JSON_ARRAY(JSON_OBJECT('id','B1','row','B','number',1,'type','standard'),JSON_OBJECT('id','B2','row','B','number',2,'type','standard'),JSON_OBJECT('id','B3','row','B','number',3,'type','standard'),JSON_OBJECT('id','B4','row','B','number',4,'type','standard'),JSON_OBJECT('id','B5','row','B','number',5,'type','standard'),JSON_OBJECT('id','B6','row','B','number',6,'type','standard'),JSON_OBJECT('id','B7','row','B','number',7,'type','standard'),JSON_OBJECT('id','B8','row','B','number',8,'type','standard'),JSON_OBJECT('id','B9','row','B','number',9,'type','standard'),JSON_OBJECT('id','B10','row','B','number',10,'type','standard')),
    JSON_ARRAY(JSON_OBJECT('id','C1','row','C','number',1,'type','standard'),JSON_OBJECT('id','C2','row','C','number',2,'type','standard'),JSON_OBJECT('id','C3','row','C','number',3,'type','standard'),JSON_OBJECT('id','C4','row','C','number',4,'type','standard'),JSON_OBJECT('id','C5','row','C','number',5,'type','standard'),JSON_OBJECT('id','C6','row','C','number',6,'type','standard'),JSON_OBJECT('id','C7','row','C','number',7,'type','standard'),JSON_OBJECT('id','C8','row','C','number',8,'type','standard'),JSON_OBJECT('id','C9','row','C','number',9,'type','standard'),JSON_OBJECT('id','C10','row','C','number',10,'type','standard')),
    JSON_ARRAY(JSON_OBJECT('id','D1','row','D','number',1,'type','standard'),JSON_OBJECT('id','D2','row','D','number',2,'type','standard'),JSON_OBJECT('id','D3','row','D','number',3,'type','standard'),JSON_OBJECT('id','D4','row','D','number',4,'type','standard'),JSON_OBJECT('id','D5','row','D','number',5,'type','standard'),JSON_OBJECT('id','D6','row','D','number',6,'type','standard'),JSON_OBJECT('id','D7','row','D','number',7,'type','standard'),JSON_OBJECT('id','D8','row','D','number',8,'type','standard'),JSON_OBJECT('id','D9','row','D','number',9,'type','standard'),JSON_OBJECT('id','D10','row','D','number',10,'type','standard')),
    JSON_ARRAY(JSON_OBJECT('id','E1','row','E','number',1,'type','vip'),JSON_OBJECT('id','E2','row','E','number',2,'type','vip'),JSON_OBJECT('id','E3','row','E','number',3,'type','vip'),JSON_OBJECT('id','E4','row','E','number',4,'type','vip'),JSON_OBJECT('id','E5','row','E','number',5,'type','vip'),JSON_OBJECT('id','E6','row','E','number',6,'type','vip'),JSON_OBJECT('id','E7','row','E','number',7,'type','vip'),JSON_OBJECT('id','E8','row','E','number',8,'type','vip'),JSON_OBJECT('id','E9','row','E','number',9,'type','vip'),JSON_OBJECT('id','E10','row','E','number',10,'type','vip')),
    JSON_ARRAY(JSON_OBJECT('id','F1','row','F','number',1,'type','vip'),JSON_OBJECT('id','F2','row','F','number',2,'type','vip'),JSON_OBJECT('id','F3','row','F','number',3,'type','vip'),JSON_OBJECT('id','F4','row','F','number',4,'type','vip'),JSON_OBJECT('id','F5','row','F','number',5,'type','vip'),JSON_OBJECT('id','F6','row','F','number',6,'type','vip'),JSON_OBJECT('id','F7','row','F','number',7,'type','vip'),JSON_OBJECT('id','F8','row','F','number',8,'type','vip'),JSON_OBJECT('id','F9','row','F','number',9,'type','vip'),JSON_OBJECT('id','F10','row','F','number',10,'type','vip')),
    JSON_ARRAY(JSON_OBJECT('id','G1','row','G','number',1,'type','couple'),JSON_OBJECT('id','G2','row','G','number',2,'type','couple'),JSON_OBJECT('id','G3','row','G','number',3,'type','couple'),JSON_OBJECT('id','G4','row','G','number',4,'type','couple'),JSON_OBJECT('id','G5','row','G','number',5,'type','couple')),
    JSON_ARRAY(JSON_OBJECT('id','H1','row','H','number',1,'type','couple'),JSON_OBJECT('id','H2','row','H','number',2,'type','couple'),JSON_OBJECT('id','H3','row','H','number',3,'type','couple'),JSON_OBJECT('id','H4','row','H','number',4,'type','couple'),JSON_OBJECT('id','H5','row','H','number',5,'type','couple'))
  ),
  'pricing', JSON_OBJECT('standard', 1.0, 'vip', 1.5, 'couple', 2.0),
  'metadata', JSON_OBJECT('screen', 'front', 'aisles', JSON_ARRAY(3,7), 'wheelchairAccessible', JSON_ARRAY('A1','A10'))
)),

-- Theater 2: Standard (4 rows x 10 standard + 2 rows x 10 vip + 2 rows x 5 couple = 60 seats)
('Phòng 2 - Standard', 60, 'standard', 'active',
'{"rows":["A","B","C","D","E","F","G","H"],"seatsPerRow":10,"layout":[[{"id":"A1","row":"A","number":1,"type":"standard"},{"id":"A2","row":"A","number":2,"type":"standard"},{"id":"A3","row":"A","number":3,"type":"standard"},{"id":"A4","row":"A","number":4,"type":"standard"},{"id":"A5","row":"A","number":5,"type":"standard"},{"id":"A6","row":"A","number":6,"type":"standard"},{"id":"A7","row":"A","number":7,"type":"standard"},{"id":"A8","row":"A","number":8,"type":"standard"},{"id":"A9","row":"A","number":9,"type":"standard"},{"id":"A10","row":"A","number":10,"type":"standard"}],[{"id":"B1","row":"B","number":1,"type":"standard"},{"id":"B2","row":"B","number":2,"type":"standard"},{"id":"B3","row":"B","number":3,"type":"standard"},{"id":"B4","row":"B","number":4,"type":"standard"},{"id":"B5","row":"B","number":5,"type":"standard"},{"id":"B6","row":"B","number":6,"type":"standard"},{"id":"B7","row":"B","number":7,"type":"standard"},{"id":"B8","row":"B","number":8,"type":"standard"},{"id":"B9","row":"B","number":9,"type":"standard"},{"id":"B10","row":"B","number":10,"type":"standard"}],[{"id":"C1","row":"C","number":1,"type":"standard"},{"id":"C2","row":"C","number":2,"type":"standard"},{"id":"C3","row":"C","number":3,"type":"standard"},{"id":"C4","row":"C","number":4,"type":"standard"},{"id":"C5","row":"C","number":5,"type":"standard"},{"id":"C6","row":"C","number":6,"type":"standard"},{"id":"C7","row":"C","number":7,"type":"standard"},{"id":"C8","row":"C","number":8,"type":"standard"},{"id":"C9","row":"C","number":9,"type":"standard"},{"id":"C10","row":"C","number":10,"type":"standard"}],[{"id":"D1","row":"D","number":1,"type":"standard"},{"id":"D2","row":"D","number":2,"type":"standard"},{"id":"D3","row":"D","number":3,"type":"standard"},{"id":"D4","row":"D","number":4,"type":"standard"},{"id":"D5","row":"D","number":5,"type":"standard"},{"id":"D6","row":"D","number":6,"type":"standard"},{"id":"D7","row":"D","number":7,"type":"standard"},{"id":"D8","row":"D","number":8,"type":"standard"},{"id":"D9","row":"D","number":9,"type":"standard"},{"id":"D10","row":"D","number":10,"type":"standard"}],[{"id":"E1","row":"E","number":1,"type":"vip"},{"id":"E2","row":"E","number":2,"type":"vip"},{"id":"E3","row":"E","number":3,"type":"vip"},{"id":"E4","row":"E","number":4,"type":"vip"},{"id":"E5","row":"E","number":5,"type":"vip"},{"id":"E6","row":"E","number":6,"type":"vip"},{"id":"E7","row":"E","number":7,"type":"vip"},{"id":"E8","row":"E","number":8,"type":"vip"},{"id":"E9","row":"E","number":9,"type":"vip"},{"id":"E10","row":"E","number":10,"type":"vip"}],[{"id":"F1","row":"F","number":1,"type":"vip"},{"id":"F2","row":"F","number":2,"type":"vip"},{"id":"F3","row":"F","number":3,"type":"vip"},{"id":"F4","row":"F","number":4,"type":"vip"},{"id":"F5","row":"F","number":5,"type":"vip"},{"id":"F6","row":"F","number":6,"type":"vip"},{"id":"F7","row":"F","number":7,"type":"vip"},{"id":"F8","row":"F","number":8,"type":"vip"},{"id":"F9","row":"F","number":9,"type":"vip"},{"id":"F10","row":"F","number":10,"type":"vip"}],[{"id":"G1","row":"G","number":1,"type":"couple"},{"id":"G2","row":"G","number":2,"type":"couple"},{"id":"G3","row":"G","number":3,"type":"couple"},{"id":"G4","row":"G","number":4,"type":"couple"},{"id":"G5","row":"G","number":5,"type":"couple"}],[{"id":"H1","row":"H","number":1,"type":"couple"},{"id":"H2","row":"H","number":2,"type":"couple"},{"id":"H3","row":"H","number":3,"type":"couple"},{"id":"H4","row":"H","number":4,"type":"couple"},{"id":"H5","row":"H","number":5,"type":"couple"}]],"pricing":{"standard":1.0,"vip":1.5,"couple":2.0},"metadata":{"screen":"front","aisles":[3,7],"wheelchairAccessible":["A1","A10"]}}'),
...
-- Theater 5: 3D (4 rows x 10 standard + 2 rows x 10 vip + 2 rows x 5 couple = 60 seats)
('Phòng 5 - 3D', 60, '3d', 'active',
'{"rows":["A","B","C","D","E","F","G","H"],"seatsPerRow":10,"layout":[[{"id":"A1","row":"A","number":1,"type":"standard"},{"id":"A2","row":"A","number":2,"type":"standard"},{"id":"A3","row":"A","number":3,"type":"standard"},{"id":"A4","row":"A","number":4,"type":"standard"},{"id":"A5","row":"A","number":5,"type":"standard"},{"id":"A6","row":"A","number":6,"type":"standard"},{"id":"A7","row":"A","number":7,"type":"standard"},{"id":"A8","row":"A","number":8,"type":"standard"},{"id":"A9","row":"A","number":9,"type":"standard"},{"id":"A10","row":"A","number":10,"type":"standard"}],[{"id":"B1","row":"B","number":1,"type":"standard"},{"id":"B2","row":"B","number":2,"type":"standard"},{"id":"B3","row":"B","number":3,"type":"standard"},{"id":"B4","row":"B","number":4,"type":"standard"},{"id":"B5","row":"B","number":5,"type":"standard"},{"id":"B6","row":"B","number":6,"type":"standard"},{"id":"B7","row":"B","number":7,"type":"standard"},{"id":"B8","row":"B","number":8,"type":"standard"},{"id":"B9","row":"B","number":9,"type":"standard"},{"id":"B10","row":"B","number":10,"type":"standard"}],[{"id":"C1","row":"C","number":1,"type":"standard"},{"id":"C2","row":"C","number":2,"type":"standard"},{"id":"C3","row":"C","number":3,"type":"standard"},{"id":"C4","row":"C","number":4,"type":"standard"},{"id":"C5","row":"C","number":5,"type":"standard"},{"id":"C6","row":"C","number":6,"type":"standard"},{"id":"C7","row":"C","number":7,"type":"standard"},{"id":"C8","row":"C","number":8,"type":"standard"},{"id":"C9","row":"C","number":9,"type":"standard"},{"id":"C10","row":"C","number":10,"type":"standard"}],[{"id":"D1","row":"D","number":1,"type":"standard"},{"id":"D2","row":"D","number":2,"type":"standard"},{"id":"D3","row":"D","number":3,"type":"standard"},{"id":"D4","row":"D","number":4,"type":"standard"},{"id":"D5","row":"D","number":5,"type":"standard"},{"id":"D6","row":"D","number":6,"type":"standard"},{"id":"D7","row":"D","number":7,"type":"standard"},{"id":"D8","row":"D","number":8,"type":"standard"},{"id":"D9","row":"D","number":9,"type":"standard"},{"id":"D10","row":"D","number":10,"type":"standard"}],[{"id":"E1","row":"E","number":1,"type":"vip"},{"id":"E2","row":"E","number":2,"type":"vip"},{"id":"E3","row":"E","number":3,"type":"vip"},{"id":"E4","row":"E","number":4,"type":"vip"},{"id":"E5","row":"E","number":5,"type":"vip"},{"id":"E6","row":"E","number":6,"type":"vip"},{"id":"E7","row":"E","number":7,"type":"vip"},{"id":"E8","row":"E","number":8,"type":"vip"},{"id":"E9","row":"E","number":9,"type":"vip"},{"id":"E10","row":"E","number":10,"type":"vip"}],[{"id":"F1","row":"F","number":1,"type":"vip"},{"id":"F2","row":"F","number":2,"type":"vip"},{"id":"F3","row":"F","number":3,"type":"vip"},{"id":"F4","row":"F","number":4,"type":"vip"},{"id":"F5","row":"F","number":5,"type":"vip"},{"id":"F6","row":"F","number":6,"type":"vip"},{"id":"F7","row":"F","number":7,"type":"vip"},{"id":"F8","row":"F","number":8,"type":"vip"},{"id":"F9","row":"F","number":9,"type":"vip"},{"id":"F10","row":"F","number":10,"type":"vip"}],[{"id":"G1","row":"G","number":1,"type":"couple"},{"id":"G2","row":"G","number":2,"type":"couple"},{"id":"G3","row":"G","number":3,"type":"couple"},{"id":"G4","row":"G","number":4,"type":"couple"},{"id":"G5","row":"G","number":5,"type":"couple"}],[{"id":"H1","row":"H","number":1,"type":"couple"},{"id":"H2","row":"H","number":2,"type":"couple"},{"id":"H3","row":"H","number":3,"type":"couple"},{"id":"H4","row":"H","number":4,"type":"couple"},{"id":"H5","row":"H","number":5,"type":"couple"}]],"pricing":{"standard":1.0,"vip":1.5,"couple":2.0},"metadata":{"screen":"front","aisles":[3,7],"wheelchairAccessible":["A1","A10"]}}'),
